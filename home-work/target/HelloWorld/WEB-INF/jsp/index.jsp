...
<script>
    ...
    function add(){//添加
        ...
        layer.open({
            ...
            area: ['800px', '600px'], //宽高
            content: '${pageContext.request.contextPath}/library/addBook.do'
        });
    }
    ...
    layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'slider'], function(){
        ...
        table.render({
            elem: '#demo'
            ,height: 550
            ,url: '${pageContext.request.contextPath}/library/findAll' //数据接口
            ,title: '图书表'
            ,page: true
            ,limit: 5
            ,limits: [5,10,15,20]
            ,cols: [[ //表头
                ...
                ,{field: 'bookId', title: '图书编号', width:150, sort: true}
        ...
        function del(bookId,obj,index){
            $.ajax({
                url:'${pageContext.request.contextPath}/library/delBook?bookId='+bookId,
                dataType:'json',
                type:'post',
        ...
        function edit(data){//修改
            ...
            layer.open({
                ...
                area: ['800px', '600px'], //宽高
                method: 'post',
                content: '${pageContext.request.contextPath}/library/editBook?'
                +'bookId='+data.bookId
            });
        }

        function find(data){   //根据id查询书籍
            layer.open({
                type: 2,
                title: '查看图书信息',
                skin: 'layui-layer-demo', //加上边框
                area: ['800px', '600px'], //宽高
                method: 'post',
                content: '${pageContext.request.contextPath}/library/findBook?'
                +'bookId='+data.bookId
            });
        }
