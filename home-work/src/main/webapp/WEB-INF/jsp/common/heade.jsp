...
<div class="layui-header">
    ...
    <ul class="layui-nav layui-layout-left">
        ...
        <c:if test="${admin!=null}">
            ...
            <li class="layui-nav-item"><a href="${pageContext.request.contextPath}/reader/readerIndex.htm">用户列表</a></li>
    ...
    <ul class="layui-nav layui-layout-right">
        <li class="layui-nav-item">
            <a href="javascript:;">
                <img src="${pageContext.request.contextPath}/images/touxaing5.jpg" class="layui-nav-img">
                <%--${admin2.name }--%>
                ${reader.name}
            </a>
        </li>
