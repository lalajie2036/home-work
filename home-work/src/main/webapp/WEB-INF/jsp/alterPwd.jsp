...
<div class="login-main">
    ...
    <div style="padding: 15px;">
        <form class="layui-form" action="${pageContext.request.contextPath}/alterpwd.action" method="post">
    ...
    <script type="text/javascript">
        layui.use(['form','jquery','layer'], function () {
            ...
            $('#user').blur(function() {
                var user = $(this).val();
                $.ajax({
                    url:'${pageContext.request.contextPath}/checkPwd.do?',
                    type:'post',
                    dataType:'json',
            ...
            form.on('submit(sub)', function(data) {
                $.ajax({
                    url:'${pageContext.request.contextPath}/alterpwd.do',
                    data:data.field,
                    dataType:'json',
                    type:'post',
                    success:function(data){
                        if (data.success) {
                            layer.alert(data.message,function(){
                                window.parent.location.href = "${pageContext.request.contextPath}/toLogin.htm";//刷新父页面
