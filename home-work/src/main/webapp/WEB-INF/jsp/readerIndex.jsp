...
<script>
    ...
    function add(){//添加
        ...
        layer.open({
            ...
            area: ['800px', '500px'], //宽高
            content: '${pageContext.request.contextPath}/reader/addReader'
        });
    }
    ...
    layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'slider'], function(){
        ...
        table.render({
            elem: '#demo'
            ,height: 550
            ,url: '${pageContext.request.contextPath}/reader/listReader' //数据接口
            ,title: '图书表'
            ,page: true
            ,limit: 6
            ,limits: [5,10,15,20]
...
//后边两个参数仅仅是因为要执行动态删除dom
        function del(id,obj,index){
            $.ajax({
                url:'${pageContext.request.contextPath}/reader/delReader?id='+id,
                dataType:'json',
                type:'post',
        ...
        function edit(data){//修改
            ...
            layer.open({
                ...
                area: ['800px', '500px'], //宽高
                method: 'post',
                content: '${pageContext.request.contextPath}/reader/editReader?'
                +'id='+data.id
            });
        }
        ...
        function find(data){
            layer.open({
                ...
                area: ['800px', '500px'], //宽高
                method: 'post',
                content: '${pageContext.request.contextPath}/reader/findReader?'
                +'id='+data.id
            });
        }
    });
