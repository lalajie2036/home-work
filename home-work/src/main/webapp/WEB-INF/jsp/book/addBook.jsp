...
<head>
    ...
    <link href="${pageContext.request.contextPath}/css/modules/laydate/default/laydate.css" >
...
<body>
<form class="layui-form" action="${pageContext.request.contextPath}/library/AddBook" method="post" id="addbook" lay-filter="example">
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <textarea style="width:600px; height:150px" placeholder="请输入图书描述" name="introduction"  lay-verify="required"  class="layui-textarea">${bookinfo.introduction}</textarea>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
...
//            }
            ...
            $.ajax({
                url:'${pageContext.request.contextPath}/library/AddBook',
                data:data.field,
                dataType:'json',
                type:'post',
...
//            }
            ...
            $.ajax({
                url:'${pageContext.request.contextPath}/library/updateBook',
                data:data.field,
                dataType:'json',
                type:'post',
                success:function (data) {
