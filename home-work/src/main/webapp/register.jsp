...
<div class="login-main">
    <header class="layui-elip" style="width: 82%; font-size: 30px;text-align: center;margin-bottom: 20px">注册页</header>
    ...
    <form class="layui-form" method="post" action="/register">
        <div class="layui-form-item">
            ...
            <div class="layui-inline" style="width: 85%">
                <input type="text" id="user" name="reader" required lay-verify="required" placeholder="请输入你的昵称"
        ...
        <div class="layui-form-item">
            ...
            <!-- 错号 -->
            <div class="layui-inline">
                <i class="layui-icon" id="wrn" style="color: red; font-weight: bolder;" hidden>ဆ</i>
            </div>
        </div>
        <!-- 密码 -->
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            <button type="submit" lay-submit lay-filter="sub" class="layui-btn" style="width: 85%">注册
            </button>
        </div>
        <hr style="width: 85%"/>
