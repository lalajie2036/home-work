...
<jsp:useBean id="user" class="cn.edu.niit.javabean.User" scope="session"/>
								...
								<div class="layui-form" lay-filter="">
									<div class="layui-form-item">
										...
										<div class="layui-input-inline">
											<input type="text" name="username" value="<jsp:getProperty name="user" property="username"/>" readonly class="layui-input">
										</div>
									...
									<div class="layui-form-item">
										...
										<div class="layui-input-block">
											<input type="radio" name="sex" value="男" title="男"<%=user.isSex() ? "checked" : ""%>/>
											<input type="radio" name="sex" value="女" title="女" <%=user.isSex() ? "" : "checked"%>/>
										</div>
									</div>
									<div class="layui-form-item">
...
<%--																						   lay-verify="required"--%>
<%--																						   id="LAY_avatarSrc"--%>
<%--																						   placeholder="/imgs/header.jpg"--%>
<%--																						   value=""--%>
<%--																						   class="layui-input">--%>
<%--																				</div>--%>
										<div class="layui-input-inline" style="width: auto;">
											<input type="file" class="layui-btn layui-btn-primary" name="avatar"/>
										</div>
									</div>
									<div class="layui-form-item">
									...
									<div class="layui-form-item layui-form-text">
										...
										<div class="layui-input-block">
										<textarea name="remarks"placeholder="请输入内容" class="layui-textarea"><jsp:getProperty name="user" property="describe"/>
										</textarea>
										</div>
									</div>
									<div class="layui-form-item">
