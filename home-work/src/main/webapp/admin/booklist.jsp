...
<div class="layui-form" id="content"><br/>
    <button type="button" class="layui-btn  layui-btn-sm" id="addBooksBtn" lay-event="add"><i class="layui-icon">添加图书</i></button>
...
<div id="page" style="display: flex;justify-content: center;">添加图书</div>
